...
import './login.css';
import top from './log in/side.png';
      ...
      <div className="login-box">
        ...
        <div className="form-section">
          <form className="login-form">
            ...
            <h2 style={{display:"flex"}}><span className="highlight" > Welcome  </span> Back!</h2>
            <p>Enjoy all the features that make it easy for you to manage your finances</p>
            ...
            <label htmlFor="password"style={{ color: 'black',display:"flex"}}>Password <span className="required">*</span></label>
